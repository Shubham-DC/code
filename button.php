...
<br/>
	...
	<br/>  
	<li class="media"> <img class="mr-3" src="icon.png" alt="Generic placeholder image"> 
	<div class="media-body"> <h5 class="mt-0 mb-1">
	<a href="docs/<?php echo "test.txt";?>">ATTACHMENT1</a>
	 </h5> Description of Resource whose link is provided above </div> </li>
<br/>
